...
class TestPaymentprocessorPaymentMethod(unittest.TestCase):
    """PaymentprocessorPaymentMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentprocessorPaymentMethod:
        """Test PaymentprocessorPaymentMethod
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentprocessorPaymentMethod`
        """
        model = PaymentprocessorPaymentMethod()
        if include_optional:
    ...
    def testPaymentprocessorPaymentMethod(self):
        """Test PaymentprocessorPaymentMethod"""
