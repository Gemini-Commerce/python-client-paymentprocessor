...
class TestPaymentprocessorListPaymentMethodsResponse(unittest.TestCase):
    """PaymentprocessorListPaymentMethodsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentprocessorListPaymentMethodsResponse:
        """Test PaymentprocessorListPaymentMethodsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentprocessorListPaymentMethodsResponse`
        """
        model = PaymentprocessorListPaymentMethodsResponse()
        if include_optional:
    ...
    def testPaymentprocessorListPaymentMethodsResponse(self):
        """Test PaymentprocessorListPaymentMethodsResponse"""
