...
class TestPaymentprocessorPaymentContext(unittest.TestCase):
    """PaymentprocessorPaymentContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentprocessorPaymentContext:
        """Test PaymentprocessorPaymentContext
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentprocessorPaymentContext`
        """
        model = PaymentprocessorPaymentContext()
        if include_optional:
            return PaymentprocessorPaymentContext(
    ...
    def testPaymentprocessorPaymentContext(self):
        """Test PaymentprocessorPaymentContext"""
