...
class TestPaymentprocessorAvailabilityContext(unittest.TestCase):
    """PaymentprocessorAvailabilityContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentprocessorAvailabilityContext:
        """Test PaymentprocessorAvailabilityContext
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentprocessorAvailabilityContext`
        """
        model = PaymentprocessorAvailabilityContext()
        if include_optional:
            return PaymentprocessorAvailabilityContext(
    ...
    def testPaymentprocessorAvailabilityContext(self):
        """Test PaymentprocessorAvailabilityContext"""
