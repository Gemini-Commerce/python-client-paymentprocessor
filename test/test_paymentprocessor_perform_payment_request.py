...
class TestPaymentprocessorPerformPaymentRequest(unittest.TestCase):
    """PaymentprocessorPerformPaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentprocessorPerformPaymentRequest:
        """Test PaymentprocessorPerformPaymentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentprocessorPerformPaymentRequest`
        """
        model = PaymentprocessorPerformPaymentRequest()
        if include_optional:
            return PaymentprocessorPerformPaymentRequest(
                tenant_id = '',
                payment_id = '',
    ...
    def testPaymentprocessorPerformPaymentRequest(self):
        """Test PaymentprocessorPerformPaymentRequest"""
