...
class TestPaymentprocessorFinalizePaymentRequest(unittest.TestCase):
    """PaymentprocessorFinalizePaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentprocessorFinalizePaymentRequest:
        """Test PaymentprocessorFinalizePaymentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentprocessorFinalizePaymentRequest`
        """
        model = PaymentprocessorFinalizePaymentRequest()
        if include_optional:
            return PaymentprocessorFinalizePaymentRequest(
                tenant_id = '',
                payment_id = '',
    ...
    def testPaymentprocessorFinalizePaymentRequest(self):
        """Test PaymentprocessorFinalizePaymentRequest"""
