...
class TestPaymentprocessorInitPaymentRequest(unittest.TestCase):
    """PaymentprocessorInitPaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentprocessorInitPaymentRequest:
        """Test PaymentprocessorInitPaymentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentprocessorInitPaymentRequest`
        """
        model = PaymentprocessorInitPaymentRequest()
        if include_optional:
            return PaymentprocessorInitPaymentRequest(
                tenant_id = '',
    ...
    def testPaymentprocessorInitPaymentRequest(self):
        """Test PaymentprocessorInitPaymentRequest"""
