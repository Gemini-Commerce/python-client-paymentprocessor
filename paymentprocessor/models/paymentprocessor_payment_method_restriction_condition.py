...
class PaymentprocessorPaymentMethodRestrictionCondition(BaseModel):
    """
    ...
    condition: Optional[PaymentMethodRestrictionConditionCondition] = None
    values: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["contextPath", "action", "condition", "values"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentprocessorPaymentMethodRestrictionCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentprocessorPaymentMethodRestrictionCondition from a dict"""
        if obj is None:
            return None
