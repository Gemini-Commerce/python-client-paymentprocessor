...
class PaymentprocessorCreatePaymentMethodRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "code", "title", "label", "enabled", "amount", "currency", "configuration", "isUpfront", "description", "restrictions"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentprocessorCreatePaymentMethodRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentprocessorCreatePaymentMethodRequest from a dict"""
        if obj is None:
            return None
