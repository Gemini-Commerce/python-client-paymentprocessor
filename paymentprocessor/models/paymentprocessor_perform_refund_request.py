...
class PaymentprocessorPerformRefundRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "refundId", "payment", "amount", "currency"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentprocessorPerformRefundRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentprocessorPerformRefundRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "payment": PaymentprocessorPayment.from_dict(obj.get("payment")) if obj.get("payment") is not None else None,
