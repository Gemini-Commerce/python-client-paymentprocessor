...
class PaymentprocessorPaymentMethod(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "title", "label", "enabled", "amount", "currency", "additionalInfo", "isUpfront", "description", "restrictions"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentprocessorPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentprocessorPaymentMethod from a dict"""
        if obj is None:
            return None
