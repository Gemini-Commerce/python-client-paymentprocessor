...
class PaymentprocessorItem(BaseModel):
    """
    ...
    unit_sale_price: Optional[PaymentprocessorMoney] = Field(default=None, alias="unitSalePrice")
    unit_list_price: Optional[PaymentprocessorMoney] = Field(default=None, alias="unitListPrice")
    unit_base_price: Optional[PaymentprocessorMoney] = Field(default=None, alias="unitBasePrice")
    unit_vat_amount: Optional[PaymentprocessorMoney] = Field(default=None, alias="unitVatAmount")
    row_sale_price: Optional[PaymentprocessorMoney] = Field(default=None, alias="rowSalePrice")
    row_list_price: Optional[PaymentprocessorMoney] = Field(default=None, alias="rowListPrice")
    row_vat_amount: Optional[PaymentprocessorMoney] = Field(default=None, alias="rowVatAmount")
    discount_amount: Optional[PaymentprocessorMoney] = Field(default=None, alias="discountAmount")
    row_base_price: Optional[PaymentprocessorMoney] = Field(default=None, alias="rowBasePrice")
    ...
    __properties: ClassVar[List[str]] = ["id", "productGrn", "qtyOrdered", "qtyCommitted", "unitSalePrice", "unitListPrice", "unitBasePrice", "unitVatAmount", "rowSalePrice", "rowListPrice", "rowVatAmount", "discountAmount", "rowBasePrice", "vatPercentage", "vatInaccurate", "vatCalculated", "productName", "productCode", "productSku", "productOptions", "productImg", "productData", "shipmentInfoReference", "promotionGrn", "productIsVirtual"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentprocessorItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentprocessorItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "unitSalePrice": PaymentprocessorMoney.from_dict(obj.get("unitSalePrice")) if obj.get("unitSalePrice") is not None else None,
            "unitListPrice": PaymentprocessorMoney.from_dict(obj.get("unitListPrice")) if obj.get("unitListPrice") is not None else None,
            "unitBasePrice": PaymentprocessorMoney.from_dict(obj.get("unitBasePrice")) if obj.get("unitBasePrice") is not None else None,
            "unitVatAmount": PaymentprocessorMoney.from_dict(obj.get("unitVatAmount")) if obj.get("unitVatAmount") is not None else None,
            "rowSalePrice": PaymentprocessorMoney.from_dict(obj.get("rowSalePrice")) if obj.get("rowSalePrice") is not None else None,
            "rowListPrice": PaymentprocessorMoney.from_dict(obj.get("rowListPrice")) if obj.get("rowListPrice") is not None else None,
            "rowVatAmount": PaymentprocessorMoney.from_dict(obj.get("rowVatAmount")) if obj.get("rowVatAmount") is not None else None,
            "discountAmount": PaymentprocessorMoney.from_dict(obj.get("discountAmount")) if obj.get("discountAmount") is not None else None,
            "rowBasePrice": PaymentprocessorMoney.from_dict(obj.get("rowBasePrice")) if obj.get("rowBasePrice") is not None else None,
