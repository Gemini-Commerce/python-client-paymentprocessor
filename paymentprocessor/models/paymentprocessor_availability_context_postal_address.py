...
class PaymentprocessorAvailabilityContextPostalAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["regionCode", "postalCode", "firstname", "lastname", "addressLines", "additionalInfo"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentprocessorAvailabilityContextPostalAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentprocessorAvailabilityContextPostalAddress from a dict"""
        if obj is None:
            return None
